...
import { saveGoal, getCategories } from "@/lib/data-store"
      ...
      <DashboardLayout>
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          <div>
            ...
            <p className="text-gray-500 mt-1">Defina um objetivo financeiro para acompanhar</p>
          </div>

          <Card>
            <CardHeader>
              <CardTitle>Informações da Meta</CardTitle>
              <CardDescription>Preencha os dados abaixo para criar sua meta</CardDescription>
            </CardHeader>
            <CardContent>
